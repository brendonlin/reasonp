...
def sample_df():
    data = [
        ("A", "P1", "2021-03-02", 1, 10),
        ("B", "P1", "2021-03-02", 1, 13),
        ("A", "P2", "2021-03-02", 1, 11),
        ("B", "P2", "2021-03-02", 1, 15),
        ("A", "P1", "2021-03-03", 3, 12),
        ("B", "P1", "2021-03-03", 4, 13),
        ("A", "P2", "2021-03-03", 1, 9),
        ("B", "P2", "2021-03-03", 2, 20),
        ("C", "P2", "2021-03-03", 1, 11),
    ]
    df = pd.DataFrame(data, columns=["source", "platform", "date", "orders", "users"])
    return df
...
def test_find_reason_with_weight(sample_df):
    rdf = rp.find_reason(
        sample_df,
        compare_column="date",
        compare_values=["2021-03-03", "2021-03-02"],
        compare_metric=("orders", "sum"),
        weight_metric=("users", "sum"),
    )
    assert rdf.shape[0] > 0
